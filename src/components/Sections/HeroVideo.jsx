  ...
  return (
    <article className={`relative h-full md:h-screen max-h-[700px] ${className}`} {...props}>
      ...
      <div className="flex justify-center md:justify-start">
        <h1 className={`text-center md:text-left px-section h1-xsmall opacity-0 transition-opacity duration-3000 ease-in-out text-secondary-text absolute bottom-20 flex flex-col ${show ? "opacity-100" : ""}`}>
          {text1} <span className="h1-xsmall">{text2}</span>
        </h1>
      </div>
    </article>
  );
